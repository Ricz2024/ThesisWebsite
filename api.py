...
def translate():
    ...
    from_lang = request.form['languages_from']
    print(sourcetext)
    print(languages)
    # print(audiofile)
    ...
    if sourcetext == '':
        ...
        if languages == 'sinama':
            ...
            try:
                ...
                print(e)
                res = "I'm sorry. Unfortunately, we couldn't find the word you were looking for. "
        return render_template('index.html', res=res, datetoday2=datetime.datetime.now(), sourcetext2=sourcetext2,defaults=from_lang,default_language=languages )
...
if __name__ == '__main__':
    app.run(debug=True)
    #app.run(debug=True, host="192.168.255.101", port="5001")
